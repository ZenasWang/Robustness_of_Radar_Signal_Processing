...
% a function to cluster the results after cfar detector
% returns the peaks from the spectrum, which are in the CFAR-mask.
...
% Alternative to the findpeaks function, much much faster.
% It also can handle ties between
% peaks.
%
