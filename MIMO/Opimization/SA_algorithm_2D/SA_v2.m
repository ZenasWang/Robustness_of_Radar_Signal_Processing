...
[Tx, Rx] = random_arrays_with_max(51, N_Tx, N_Rx);
...
[P, Tx, Rx] = rand_array_with_min_interval(Lmax_unit, N_Tx, N_Rx, min_interval_unit, radarParameter);
...
%%
save("./SA_results/SA_results_14x4_SNR-5.mat");

%%
figure(1);
plot(0:full_iter, [CRB_0, CRB], 'b')
